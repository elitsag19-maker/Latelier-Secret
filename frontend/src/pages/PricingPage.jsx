...
const PRICING_DATA = {
  ...
  'eyelash-extensions-price': {
    ...
    prices: [
      { area: 'Extension classique', price: '55$' },
      { area: 'Extension volume russe', price: '85$' },
      { area: 'Méga volume', price: '115$' },
      { area: 'Hybride', price: '75$' },
      { area: 'Retouche classique (2 sem)', price: '35$' },
      { area: 'Retouche volume (2 sem)', price: '45$' },
      { area: 'Lash lift', price: '65$' },
      { area: 'Lash lift + teinture', price: '85$' },
      { area: 'Teinture cils', price: '25$' },
      { area: 'Teinture sourcils', price: '20$' },
      { area: 'Dépose', price: '20$' },
    ],
    promotions: [
